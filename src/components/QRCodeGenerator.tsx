...
const QRCodeGenerator: React.FC<QRCodeGeneratorProps> = ({
  ...
  return <Card className="p-6 bg-white card-shadow">
      <h3 className="text-xl font-semibold text-[#5271ff] mb-4 flex items-center gap-2">
      ...
      <div className="flex flex-col items-center mt-6 space-y-4">
        {!error && <div className="p-4 bg-white rounded-lg" ref={qrCodeRef}>
            <QRCode id="qr-code" value={qrValue} size={200} />
            {/* Numeric Business ID visible under the QR */}
            <div className="flex justify-center mt-3">
              <span className="inline-block bg-gray-700 text-white px-4 py-1 rounded-full text-xs tracking-widest font-semibold shadow" style={{
            letterSpacing: "0.2em"
          }}>
        ...
        <Button onClick={downloadQRCode} variant="outline" className="w-full flex items-center justify-center gap-2" disabled={!!error} style={{
        borderColor: "#0EA5E9",
        color: "#0EA5E9"
      }}>
          <Download size={18} />
